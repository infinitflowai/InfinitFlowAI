    ...
    >
      ...
      >
        ...
        <Link
          ...
          className="relative inline-flex items-center gap-2.5 px-5 py-3 sm:px-7 sm:py-4 text-base font-semibold text-white"
          style={{
...
function StatCard({ value, label }: { value: string; label: string }) {
  return (
    <div
      className="flex-1 min-w-0 px-3 py-3.5 sm:px-4 sm:py-5 rounded-2xl text-center"
      style={{
...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-24 lg:pt-36 pb-16 overflow-hidden">
      <AnimatedBackground />

      <div className="relative z-10 w-full max-w-360 mx-auto px-6 sm:px-8 lg:px-10 xl:px-12">
        <div className="grid grid-cols-1 min-[1200px]:grid-cols-[1fr_1fr] gap-12 min-[1200px]:gap-16 xl:gap-24 items-center">
          ...
          <div>
            ...
            <motion.h1
              {...fu(0.18)}
              className="text-[34px] sm:text-5xl lg:text-[3.4rem] xl:text-6xl font-bold leading-[1.12] tracking-tight mb-4 lg:mb-6"
            >
            ...
            <motion.p
              {...fu(0.36)}
              className="text-slate-300 text-base lg:text-lg font-normal leading-relaxed mb-6 lg:mb-9 max-w-130"
            >
            ...
            {/* CTAs */}
            <motion.div {...fu(0.52)} className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-start">
            ...
            <motion.div
              {...fu(0.64)}
              className="flex items-stretch gap-2 sm:gap-3 mt-7 pt-5 sm:mt-10 sm:pt-8 border-t border-brand-navy/30"
            >
          ...
          <motion.div
            ...
            className="flex justify-center min-[1200px]:justify-end items-center md:scale-[0.82] lg:scale-100 xl:translate-x-10"
          >
