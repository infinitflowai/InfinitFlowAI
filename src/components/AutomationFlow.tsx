...
export function AutomationFlow() {
  return (
    <section className="relative min-h-[calc(100vh-80px)] lg:min-h-195 flex flex-col pt-7 pb-10 lg:pt-8 lg:pb-10">
      ...
      <div className="max-w-360 mx-auto px-6 sm:px-8 lg:px-10 xl:px-12 flex flex-col flex-1 xl:flex-none pt-8 -translate-y-3 xl:translate-y-0">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-9 lg:mt-6"
        >
          {STEPS.map((step) => (
            <motion.div
              key={step.step}
              ...
              whileHover="hovered"
              className="bg-transparent border border-slate-800/60 rounded-2xl pt-3 px-6 pb-8 sm:px-8 sm:pb-13 relative overflow-hidden flex flex-col sm:min-h-60"
            >
